  ...
  return (
    <aside className="hidden md:flex flex-col w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 h-screen sticky top-0">
      ...
      <nav className="flex-1 p-4 space-y-2">
        <Link href="/dashboard">
          <a className={`flex items-center w-full px-3 py-2 rounded-lg transition-colors ${
            activeTab === 'dashboard' 
              ? 'bg-primary bg-opacity-10 text-primary-dark dark:text-primary' 
        ...
        <div className="flex items-center justify-between">
          ...
          <button 
            ...
            className={`relative inline-flex items-center h-6 rounded-full w-11 transition-colors focus:outline-none ${
              theme === 'dark' ? 'bg-primary-dark' : 'bg-gray-300'
            }`}
          >
